...
You are given a pre-trained, **sklearn model** that has been trained to predict housing prices in Boston according to several features, such as:
- average rooms in a home and data about highway access 
